<div class="page-header">
    <h2>Historial de solicitudes de servicios / reparaciones <small>Últimas 100 </small></h2>
</div>

<?php
$query = $this->db->query('select idservicio_vehicular, placas, fecha_solicitud, estatus_autorizacion, costo_neto, observaciones, mediode_pago, modelo, usuario, nombre, ap_paterno, ap_materno, email from servicio_vehicular join vehiculos on servicio_vehicular.idvehiculo = vehiculos.idvehiculo join usuarios on   vehiculos.usuario_actual = usuarios.id order by idservicio_vehicular desc limit 0, 100');
